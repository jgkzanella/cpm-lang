...
public class cpmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "LETRA", "DIGITO", "USE", "COMMENT", "TIPO", "BOOL", 
			"DEF", "MAIN", "RETURN", "IF", "IFSE", "ELSE", "WHILE", "FOR", "SEP_RE", 
			"SEP_EX", "AC", "FC", "AP", "FP", "ACOL", "FCOL", "OP_LOG", "VARIAVEL", 
			"ATR", "MAISMENOS", "MAISMAIS", "MENOSMENOS", "OP_ARIT", "OP_REL", "NUM_INT", 
			"NUM_FLOAT", "STR", "WS", "ERROR"
		};
	}
